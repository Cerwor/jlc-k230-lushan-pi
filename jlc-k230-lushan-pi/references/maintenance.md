...
- 2026-06-13: Added board-tested rectangle detection example and replaced `sys.print_exception(e)` in templates with `print("error:", e)` for compatibility with the user's current firmware.
