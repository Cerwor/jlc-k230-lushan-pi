...
| Host unit tests | Check model package validation, probe-log acceptance, mpremote safety, and architecture guardrails | `python -m unittest discover -s tests` | No | No | None | `Ran ... tests`, `OK` |
